...
// import AsciiArtGenerator from '../src/components/AsciiArtGenerator';

// // Define the ref type locally or remove it if not needed
// type AsciiArtGeneratorRef = any; // Replace with proper type if needed
