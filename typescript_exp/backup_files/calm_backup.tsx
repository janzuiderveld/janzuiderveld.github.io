        ...
        <>
            ...
            {showDebug && (
                <div style={{
                    ...
                    <div>Grid: x={cursor.grid.x}, y={cursor.grid.y}</div>
                    <div>Normalized: x={cursor.normalized.x.toFixed(3)}, y={cursor.normalized.y.toFixed(3)}</div>
                    <div>In Window: {cursor.isInWindow.toString()}</div>
                </div>
            )}
        </>
    );
