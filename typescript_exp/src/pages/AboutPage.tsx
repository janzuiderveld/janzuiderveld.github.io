...
import { CHAR_HEIGHT, CHAR_WIDTH } from '../components/ascii-art2/constants';
...
function AboutPage() {
  ...
  useEffect(() => {
    ...
    const rows = Math.max(1, Math.ceil(windowHeight / CHAR_HEIGHT));
    ...
    const janText = [
      ...
      '[[Instagram](www.instagram.com/warana.xyz)]',
    ].join('\n');
